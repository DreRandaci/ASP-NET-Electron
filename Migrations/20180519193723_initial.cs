    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientCategory", x => x.ClientCategoryId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Client_ClientCategory_ClientCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientId = table.Column<int>(nullable: false),
                    DateDeposited = table.Column<DateTime>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Paycheck_Client_ClientId",
                        column: x => x.ClientId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ExpenseRecordId = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Amount = table.Column<double>(nullable: false),
                    Details = table.Column<string>(nullable: true),
                    ExpenseDate = table.Column<DateTime>(nullable: false),
                    ExpenseId = table.Column<int>(nullable: false),
                    RecordImage = table.Column<bool>(nullable: false),
                    RecordName = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpenseRecord", x => x.ExpenseRecordId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "ExpenseRecordImage",
                columns: table => new
                {
                    ExpenseRecordImageId = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ExpenseRecordId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpenseRecordImage", x => x.ExpenseRecordImageId);
                    table.ForeignKey(
                        name: "FK_ExpenseRecordImage_ExpenseRecord_ExpenseRecordId",
                        column: x => x.ExpenseRecordId,
                        principalTable: "ExpenseRecord",
                        principalColumn: "ExpenseRecordId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Client_ClientCategoryId",
                table: "Client",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpenseRecordImage_ExpenseRecordId",
                table: "ExpenseRecordImage",
                column: "ExpenseRecordId");

            migrationBuilder.CreateIndex(
                name: "IX_Paycheck_ClientId",
                table: "Paycheck",
                column: "ClientId");
        }
